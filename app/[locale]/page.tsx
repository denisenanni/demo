...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* wrapper relativo che contiene entrambe le section + logo watermark */}
      <div className="relative">
        {/* logo watermark — cavalca entrambe le section, sotto foto e contenuto */}
        <div
          className="absolute left-1/2 -translate-x-1/2 w-[70%] z-[5] pointer-events-none overflow-hidden"
        ...
        <section className="relative overflow-hidden bg-background min-h-[70vh] flex items-start justify-center">
          <img
            ...
            alt=""
            aria-hidden="true"
            className="absolute -top-10 left-0 z-0 w-[25%]"
          />
          <img
          ...
          <div className="relative z-10 w-full px-8 pt-12 pb-16 flex flex-col items-center">
            ...
            {/* riquadro chi sono */}
            <div className="relative flex gap-12 items-start bg-accent/50 p-10 rounded-[40px] w-[95%] shadow-[-12px_12px_24px_rgba(0,0,0,0.4)]">
              {/* testo */}
              ...
              {/* foto */}
              <div className="relative z-10 w-1/2 shrink-0 aspect-square [filter:drop-shadow(-12px_12px_24px_rgba(0,0,0,0.4))]">
        ...
        <section className="relative min-h-[80vh] flex flex-col items-center justify-start pt-16">
          <img
